...
.reset-wrapper{
    ...
    align-items:center;
    min-height:100vh; /* ✅ better center */
    padding:30px;
    position:relative;
}

/* Background circles */
.reset-wrapper .circle{
    position:absolute;
    border-radius:50%;
...
/* Footer */
.reset-wrapper .footer{
    margin-top:15px;
}

.reset-wrapper .footer a{
...
<!-- 👉 ADMIN PANEL me sirf ye div <main> ke andar paste karo -->
